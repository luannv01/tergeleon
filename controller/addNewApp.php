	...
	if(isset($_POST))
	{
		...
		if( empty( $image ) ) {
			echo 'File is empty, please select image to upload.';
			...
			if(( $ext != "jpg" ) && ( $ext != "jpeg" ) && ( $ext != "png" ) && ( $ext != "gif" ) ) {
				...
				//
					...
					$checkboxHot = isset($_POST['checkboxHot']) ? "ON" : "OFF";
					
				$yes = $app->addNewApp($_POST['name'],$_POST['os'],$_POST['size'],$_POST['version'],$status,$_POST['link_offer'],$rnd_name,$_POST['content'],$_POST['producer'],$_POST['date_update'],$_POST['view'],$checkboxHot);
				echo'success';
			}
